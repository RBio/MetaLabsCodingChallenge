...
class Api::V1::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_product" do
    assert_difference("Api::V1::Product.count") do
      post api_v1_products_url, params: { api_v1_product: { description: @api_v1_product.description, name: @api_v1_product.name, price: @api_v1_product.price, stock: @api_v1_product.stock } }
    end
  ...
  test "should update api_v1_product" do
    patch api_v1_product_url(@api_v1_product), params: { api_v1_product: { description: @api_v1_product.description, name: @api_v1_product.name, price: @api_v1_product.price, stock: @api_v1_product.stock } }
