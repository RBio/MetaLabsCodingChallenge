...
user_purchase1 = Purchase.create(user:)

PurchaseItem.create(purchase: user_purchase1, product: products[0], price: products[0].price, quantity: 1)
PurchaseItem.create(purchase: user_purchase1, product: products[2], price: products[2].price - 10, quantity: 1)
PurchaseItem.create(purchase: user_purchase1, product: products_without_stock[1],
                    price: products_without_stock[1].price - 50, quantity: 1)

user_purchase2 = Purchase.create(user:)

PurchaseItem.create(purchase: user_purchase2, product: products[0], price: products[0].price, quantity: 1)
